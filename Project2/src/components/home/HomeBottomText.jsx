...
const HomeBottomText = () => {
  return (
    <div className="font-[font2] flex items-center justify-center gap-2 ">
      <p className="absolute lg:w-[35vw] w-64 lg:right-20 right-0 top-52  lg:top-80 font-[font1] lg:text-lg text-xs lg:leading-relaxed leading-tight">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div className="lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] h-10 md:h-15 lg:h-20 flex items-center px-3 pt-1 lg:px-14 border-white rounded-full uppercase">
